 ...
 * {@link com.orbotix.colorpicker.internal.HSBColorPickerView#setOnColorChangedListener(OnColorChangedListener)}.
 * <p>
 * Make sure to set the initial color using {@link com.orbotix.colorpicker.internal.HSBColorPickerView#setNewColor(int)}.
 */
...
// TODO - Fix Styleable
	 ...
	 * {@link OnColorChangedListener} will be notified of the change.
	 *
	...
	/**
	 * Sets the {@link OnColorChangedListener} to be sensorUpdated when the color in this
	 * view is changed either by user input or by setting a color using {@link com.orbotix.colorpicker.internal.HSBColorPickerView#setNewColor(int)}.
	 */
